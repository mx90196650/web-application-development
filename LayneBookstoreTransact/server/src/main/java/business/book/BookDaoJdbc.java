...
public class BookDaoJdbc implements BookDao {
    ...
    public Book findByBookId(long bookId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding book by book id: " + bookId, e);
        }
        return book;
    }
    ...
    public List<Book> findRandomByCategoryId(long categoryId, int limit) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding suggested-books by category if: " + categoryId + " with limit: " + limit, e);
        }
